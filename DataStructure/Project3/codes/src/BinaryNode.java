/**
 ...
 The class updates implimentation of these methods.
         public void postorderTraverse_binaryNodeMethod() //Task 1
         public int getHeight_binaryNodeMethod() //Task 2
...
class BinaryNode<T>
{
   ...
   {
      //Base case (leftChild == null && rightChild == null), leaf
      if(leftChild != null){
   ...
   {
      //Base case (leftChild and rightChild == null), return current height is 1
      int lftHght = 0;
      int rghtHght = 0;
      int crrntHght = 1; // Each node has 1 degree

      if(leftChild != null){
         lftHght = leftChild.getHeight_binaryNodeMethod();
      }
      if(rightChild != null){
         rghtHght = rightChild.getHeight_binaryNodeMethod();
      }

      // Compare left child height and right child height
      //Add bigger one to current height, which means degree from bottom leaf
      crrntHght += Math.max(lftHght,rghtHght);
