 ...
 * File name: Classical.java
 * 
 * Description:
 * The class is the utility class to realize the Classical matrix multiplication method
 * It has three inner loop to calculate 2^N matrix multiplicaiton
 * Its time complety is O(N^3)
 * 
