 ...
 * File name: DivideConquer.java
 * 
 * Description:
 * The class is the utility class to realize Strassen's matrix multiplication method
 * It divides 4 sub matrices from the original matrix to calculate smaller problems
 * This methods addapts Strassen's mathmatical algorighm to reduce addition and subtracton process.
 * The method calls itself recursively until the problem size is 2 by 2 matrix multiplicaion
 * Its time complety is still O(N^2.8)
 * 
...
public class Strassen {
    ...
    /**
     * Check the number of row or number of column are the 2 ^ K where K is some integer
