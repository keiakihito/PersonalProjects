...
int main(int argv, char** argc) {
    ...
    cout << boolalpha <<big_three_test(debug) <<": copy_CTR_test finished. " <<  endl;
    cout << boolalpha <<stack_push_pop_test(debug) <<": stack_push_test finished. " <<  endl;
    cout << boolalpha <<queue_enqueue_and_dequeue_test(debug) <<": stack_push_test finished. " <<  endl;
